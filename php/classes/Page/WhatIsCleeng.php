...
<div class="left">
    ...
    <?php _e('1. Sell <strong>single items,</strong>', 'cleeng'); ?><br/>
    <?php _e('2. Provide a <strong>Daily pass</strong>(24h), or', 'cleeng'); ?><br/>
    <?php _e('3. Give access to all your content via <strong>subscriptions</strong>', 'cleeng'); ?><br/>
    <br/>
...
including:','cleeng')?>
    ...
    <br/>
    <?php _e('<strong>Daily Pass & Subscriptions</strong>', 'cleeng'); ?>
    <br style="clear:left;">

     <div style="width:530px;float:left; ">
    <?php echo sprintf(__('You might consider to offer access to your premium content to your loyal visitors
    ...
    <?php _e('<strong>Completely free to try, learn and adapt</strong>', 'cleeng'); ?>
    <br />
    ...
    ','cleeng'); ?>
<br /><br />
    <?php _e('<strong>Get paid monthly via PayPal or wire transfer</strong>', 'cleeng'); ?>
<br />
    <?php echo sprintf(__('Within your <a  href="%s/my-account/settings">profile settings</a> on Cleeng.com you can set your publisher currency
