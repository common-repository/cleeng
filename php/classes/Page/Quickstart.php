...
<?php Cleeng_Core::load('Cleeng_Page_Sidebar')->render(); ?>
            ...
            <?php echo _e('<strong>A. Log in with Cleeng</strong><br/>
            ...
            <div class="login-b"></div>
                ...
                <?php echo _e('<strong>B. Select the content to protect</strong><br/>
                ...
                <?php echo _e('<strong>C. Define item price and more <br/> </strong>After you have selected
