...
class Cleeng_Core
{
    ...
    protected static $config = array(
        ...
        'cdnUrl' =>  'd2089qbisawq08.cloudfront.net',
        'appId' => null,
        'appSecureKey' => null,
    ...
    public function setup()
    {
        ...
        //self::$config['platformUrl'] = 'dev.cleeng.com';
        //self::$config['cdnUrl'] = 'dev.cleeng.com';
    ...
    /**
     * Prevent plugin from parsing Cleeng tags, and thus making requests to Cleeng API
     */
    public static function disable_shortcode_parser()
    {
        $frontend = self::load('Cleeng_Frontend');
        remove_filter('the_content', array($frontend, 'cleeng_add_layers'), 100);
    }
