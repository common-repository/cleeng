...
<?php
    ...
    {
        ?>
<div id="cleeng-contentForm" title="Cleeng: Create new content element" style="display:none;clear:both">
...
<?php _e( 'Description', 'cleeng' ) ?>
                        ...
                        <div id="custom_date_layer" style="display: none;">
...
<?php _e( 'to:', 'cleeng' ) ?> <input type="text" id="cleeng-ContentForm-LayerEndDate"
            ...
            <div id="cleeng-ContentForm-ReferralRateSlider" style="clear:both"></div>
        </fieldset>
    </form>
    <div id="cleeng-contentForm-info" style="clear:both"></div>
    </div>
        <?php
    }
