...
class Cleeng_Admin
{
    ...
    public function add_header_scripts() {
        ...
        wp_enqueue_style( 'cleengColorpickerCSS', CLEENG_PLUGIN_URL.'css/cleengColorpicker.css' );

        wp_enqueue_style( 'cleengPrompt', CLEENG_PLUGIN_URL.'css/cleengPrompt.css' );

        wp_enqueue_script( 'cleengColorpickerJS', CLEENG_PLUGIN_URL.'js/cleengColorpicker.js' );
    ...
    public function action_admin_menu()
    {
        ...
        add_submenu_page(
            'cleeng-menu', __('Settings', 'cleeng'), __('Settings', 'cleeng'),
            'manage_options', 'cleeng/settings', array($this, 'page_settings')
        );
        
         $submenu["cleeng-menu"][] = array(
            __('<div class="external support">What is Cleeng?</div>', 'cleeng'),
            'manage_options', 'http://cleeng.com/features'
        );
        
         $submenu["cleeng-menu"][] = array(
            __('<div class="external support">Quick-start guide</div>', 'cleeng'),
            'manage_options', 'https://vimeo.com/29488655'
        );
        
        $submenu["cleeng-menu"][] = array(
            __('<div class="external support">Support & FAQ</div>', 'cleeng'),
            'manage_options', 'http://support.cleeng.com'
        );
